...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /* Bumped 64K → 96K: all screens (TOTP tiles, FP, BLE, settings) live in this
     * fixed pool at once. At 64K it ran ~75% full and opening the settings screen
     * could tip it over — and the malloc-fail handler is while(1) (silent hang).
     * 96K leaves comfortable headroom while costing only 32K of internal heap.
     * This is a project-local copy (see include/lv_conf.h) so the value survives a
     * `pio` library reinstall, unlike the old .pio/libdeps copy. */
...
#define LV_DEF_REFR_PERIOD  16      /**< [ms] — 60 fps so tileview slides / dot anims are smooth */
...
#define LV_USE_LOTTIE     0  /**< TelePager: unused (was FobBob); disables thorvg */
